...
insert into sla_condicion values (9,"Mail de usuario","","pre",'{"elementoHTML":"input","atributos":{"name":"pre-valor[]","class":"form-control select2 Mail_de_usuario","list":"usuarios","name":"Maiil_usuarios"},"texto":null,"opciones":[{"atributos":{"value":"Valor de prueba"},"texto":null}]}');
...
insert into sla_condicion values (13,"Asignar a","","post",'{"elementoHTML":"select","atributos":{"name":"","class":"form-control select2 Asignar_a"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Operador"}]}');
