...
INSERT INTO `rol` VALUES 
                        ...
                        ('categorias_listar','Poder listar las categorias existentes'),
                        ...
                        ('empresas_ver','Permite ver  empresas'),
                        ('empresas_listar','Permite listar empresas'),
                        ('estados_crear','Permite Crear estados'),
                        ('estados_editar','Permite editar estados'),
                        ('estados_ver','Permite listar los estados'),
                        ('estados_listar','Permite listar los estados'),
                        ...
                        ('departamentos_listar','Permite listar los departementos'),
                        ...
                        ('operadores_ver','Permite ver a operadores'),
                        ('operadores_listar','Permite  listar a operadores'),
                        ...
                        ('perfiles_listar','Permite listar los perfiles'),
                        ...
                        ('prioridades_ver','Permite ver las prioridades'),
                        ('prioridades_listar','Permite listar las prioridades'),
                        ('sla_crear','Permite crear un SLA'),
                        ('sla_editar','Permite editar un SLA'),
                        ('sla_eliminar','Permite eliminar un sla'),
                        ('sla_ver','Permite ver los SLAs'),
                        ('sla_listar','Permite listar los SLAs'),
                        ...
                        ('tipoTicket_listar','Permite listar los tipos de tickets existentes'),
...
INSERT INTO `operador` VALUES (1,1,'Guybrush','Threepwood','admin','$2y$12$6/1I/icTUyqYkRR3ICrv1OfsI.fBkXWnGEdtWPNNxqN/eQXcdhI8a','<p>test</p>\r\n','admin@admin.com','','2016-05-09 18:05:51','2016-05-09 18:05:51',1,1,1,null,'',0);
...
insert into ticket_tipo values (1,'Tarea','Tarea a realizar','glyphicon-check',1,3),
                                (2,'Consulta','Duda o consulta','glyphicon-bell',1,3),
                                (3,'Problema','Tengo un problema','glyphicon-wrench',1,3);
/*!40000 ALTER TABLE `ticket_tipo` ENABLE KEYS */;
UNLOCK TABLES;

LOCK TABLES `usuario` WRITE;
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
insert into usuario values (1,'Bruce','Wayne','$2y$12$6/1I/icTUyqYkRR3ICrv1OfsI.fBkXWnGEdtWPNNxqN/eQXcdhI8a','marianolopezsenes@gmail.com',null,'mi direccion','1875','Buenos Aires','5555-5555','adicional mail',1,'2016-05-23 12:30','2016-05-23 12:31',1,0);
insert into usuario values (2,'Tony','Stark','$2y$12$6/1I/icTUyqYkRR3ICrv1OfsI.fBkXWnGEdtWPNNxqN/eQXcdhI8a','brian.ducca@gmail.com',null,'mi direccion','1875','Buenos Aires','5555-5555','adicional mail',1,'2016-05-23 12:30','2016-05-23 12:31',1,0);
...
LOCK TABLES `sla_parametro` WRITE;
/*!40000 ALTER TABLE `sla_parametro` DISABLE KEYS */;
insert into sla_parametro values (1,"Es");
insert into sla_parametro values (2,"No es");
insert into sla_parametro values (3,"Empieza");
insert into sla_parametro values (4,"Contiene");
insert into sla_parametro values (5,"No Contiene");
insert into sla_parametro values (6,"Termina");
insert into sla_parametro values (7,"Igual");
insert into sla_parametro values (8,"Ultima Actividad");
insert into sla_parametro values (9,"Ultima Actividad del Usuario");
insert into sla_parametro values (10,"Ultima Actividad del Operador");
insert into sla_parametro values (11,"Desde su creación");
insert into sla_parametro values (12,"Establecer vencimiento");
insert into sla_parametro values (13,"Inmediatamente");
/*!40000 ALTER TABLE `sla_parametro` ENABLE KEYS */;
UNLOCK TABLES;

LOCK TABLES `sla_condicion` WRITE;
/*!40000 ALTER TABLE `sla_condicion` DISABLE KEYS */;
insert into sla_condicion values (1,"Asignado a","Para seleccion de Operadores","pre",'{"elementoHTML":"select","atributos":{"name":"pre-valor[]","class":"form-control select2 Asignado_A","multiple":null},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Operador"}]}');
insert into sla_condicion values (2,"Origen del Ticket","","pre",'{"elementoHTML":"select","atributos":{"name":"pre-valor[]","class":"form-control select2 Origen_del_Ticket"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione el Criterio.."},{"atributos":{"value":"0"},"texto":"Usuario"},{"atributos":{"value":"1"},"texto":"Operador"}]}');
insert into sla_condicion values (3,"Departamento","","pre",'{"elementoHTML":"select","atributos":{"name":"pre-valor[]","class":"form-control select2 Departamento","multiple":null},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Departamento"}]}');
insert into sla_condicion values (4,"Estado","","pre",'{"elementoHTML":"select","atributos":{"name":"pre-valor[]","class":"form-control select2 Estado","multiple":null},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Estado"}]}');
insert into sla_condicion values (5,"Prioridad","","pre",'{"elementoHTML":"select","atributos":{"name":"pre-valor[]","class":"form-control select2 Prioridad","multiple":null},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione una Prioridad"}]}');
insert into sla_condicion values (6,"Tipo de Ticket","","pre",'{"elementoHTML":"select","atributos":{"name":"pre-valor[]","class":"form-control select2 Tipo_de_Ticket","multiple":null},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Tipo de Ticket"}]}');
insert into sla_condicion values (7,"El mensaje contiene","","pre",'{"elementoHTML":"textarea","atributos":{"name":"pre-valor[]","class":"form-control select2 El_mensaje_contiene","maxlength":"45","rows":"2","cols":"50"},"texto":null,"opciones":[]}');
insert into sla_condicion values (8,"El asunto contiene","","pre",'{"elementoHTML":"textarea","atributos":{"name":"pre-valor[]","class":"form-control select2 El_asunto_contiene","maxlength":"45","rows":"2","cols":"50"},"texto":null,"opciones":[]}');
insert into sla_condicion values (9,"Mail de usuario","","pre",'{"elementoHTML":"input","atributos":{"name":"pre-valor[]","class":"form-control select2 Mail_de_usuario","list":"usuarios","name":"Mail_usuarios"},"texto":null,"opciones":[{"atributos":{"value":"Valor de prueba"},"texto":null}]}');
insert into sla_condicion values (10,"Empresa","","pre",'{"elementoHTML":"select","atributos":{"name":"pre-valor[]","class":"form-control select2 Empresa","multiple":null},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione una Empresa"}]}');
insert into sla_condicion values (11,"Y","","vencimiento",'{"elementoHTML":"input","atributos":{"name":"vencimiento-valor[]","class":"form-control select2 Y","type":"number"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Operador"}]}');
insert into sla_condicion values (12,"O","","vencimiento",'{"elementoHTML":"input","atributos":{"name":"vencimiento-valor[]","class":"form-control select2 O","type":"number"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Operador"}]}');
insert into sla_condicion values (13,"Asignar a","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Asignar_a"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Operador"}]}');
insert into sla_condicion values (14,"Agregar nota","","post",'{"elementoHTML":"textarea","atributos":{"name":"post-valor[]","class":"form-control select2 Agregar_nota","maxlength":"45","rows":"2","cols":"50"},"texto":null,"opciones":[]}');
insert into sla_condicion values (15,"Agregar respuesta","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Agregar_respuesta","maxlength":"45","rows":"2","cols":"50"},"texto":null,"opciones":[]}');
insert into sla_condicion values (16,"Cambiar Departamento","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Cambiar_Departamento"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Departamento"}]}');
insert into sla_condicion values (17,"Cambiar Prioridad","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Cambiar_Prioridad"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione una Prioridad"}]}');
insert into sla_condicion values (18,"Cambiar Tipo de Ticket","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Cambiar_Tipo_de_Ticket"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Tipo de Ticket"}]}');
insert into sla_condicion values (19,"Cambiar Estado","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Cambiar_Estado"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Estado"}]}');
insert into sla_condicion values (20,"Enviar mail a Usuario","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Enviar_mail_a_Usuario"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Template"}]}');
insert into sla_condicion values (21,"Enviar mail a Operador","","post",'{"elementoHTML":"select","atributos":{"name":"post-valor[]","class":"form-control select2 Enviar_mail_a_Operador"},"texto":null,"opciones":[{"atributos":{"value":"-1"},"texto":"Seleccione un Template"}]}');
/*!40000 ALTER TABLE `sla_condicion` ENABLE KEYS */;
UNLOCK TABLES;

LOCK TABLES `sla_condicion_parametros` WRITE;
/*!40000 ALTER TABLE `sla_condicion_parametros` DISABLE KEYS */;
insert into sla_condicion_parametros values (1,1);
insert into sla_condicion_parametros values (1,2);
insert into sla_condicion_parametros values (2,1);
insert into sla_condicion_parametros values (2,2);
insert into sla_condicion_parametros values (3,1);
insert into sla_condicion_parametros values (3,2);
insert into sla_condicion_parametros values (4,1);
insert into sla_condicion_parametros values (4,2);
insert into sla_condicion_parametros values (5,1);
insert into sla_condicion_parametros values (5,2);
insert into sla_condicion_parametros values (6,1);
insert into sla_condicion_parametros values (6,2);
insert into sla_condicion_parametros values (7,3);
insert into sla_condicion_parametros values (7,4);
insert into sla_condicion_parametros values (7,5);
insert into sla_condicion_parametros values (7,6);
insert into sla_condicion_parametros values (8,3);
insert into sla_condicion_parametros values (8,4);
insert into sla_condicion_parametros values (8,5);
insert into sla_condicion_parametros values (8,6);
insert into sla_condicion_parametros values (9,4);
insert into sla_condicion_parametros values (9,5);
insert into sla_condicion_parametros values (9,6);
insert into sla_condicion_parametros values (9,7);
insert into sla_condicion_parametros values (10,1);
insert into sla_condicion_parametros values (10,2);
insert into sla_condicion_parametros values (11,8);
insert into sla_condicion_parametros values (11,9);
insert into sla_condicion_parametros values (11,10);
insert into sla_condicion_parametros values (11,11);
insert into sla_condicion_parametros values (11,12);
insert into sla_condicion_parametros values (12,8);
insert into sla_condicion_parametros values (12,9);
insert into sla_condicion_parametros values (12,10);
insert into sla_condicion_parametros values (12,11);
insert into sla_condicion_parametros values (12,12);
insert into sla_condicion_parametros values (13,13);
insert into sla_condicion_parametros values (14,13);
insert into sla_condicion_parametros values (15,13);
insert into sla_condicion_parametros values (16,13);
insert into sla_condicion_parametros values (17,13);
insert into sla_condicion_parametros values (18,13);
insert into sla_condicion_parametros values (19,13);
insert into sla_condicion_parametros values (20,13);
insert into sla_condicion_parametros values (21,13);
/*!40000 ALTER TABLE `sla_condicion_parametros` ENABLE KEYS */;
UNLOCK TABLES;