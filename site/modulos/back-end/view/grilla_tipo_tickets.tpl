  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Lista Tipo de Tickets</li>
      </ol>
    </section>
   <!-- /Content Header (Page header) -->  
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
              ...
              <button class="btn btn-app "  id="btnNuevo" onclick="window.location.href='/operador.php?modulo=nuevoTipoTicket'">
                <i class="fa fa-plus"></i> Nuevo
              </button>
              <button class="btn btn-app " id="btnModificar" onclick="window.location.href='/operador.php?modulo=modificarTipoTicket'" disabled>
    ...
    <table id="grilla" class="display">
        ...
        <tbody>
            <tr>
                ...
                <td>Consultas</td>
                <td>Consultas varias</td>
            </tr>
            <tr>
                <td><input type="checkbox"></input></td>
                <td>Problema</td>
                <td>Problemas o errores a tratar.</td>
            </tr>
            <tr>
                <td><input type="checkbox"></input></td>
                <td>Presupuesto</td>
                <td>Solicitud de presupuestos</td>
            </tr>
        </tbody>
    </table>
