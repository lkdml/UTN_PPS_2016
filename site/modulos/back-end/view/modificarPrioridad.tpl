...
<div class="content-wrapper">
 ...
 <section class="content-header">
   <h1>
      <strong>Modificar Prioridad</strong>
     <small></small>
   </h1>
   <ol class="breadcrumb">
     <li><a href="/operador.php?modulo=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
     <li class="active">Administración > Prioridades > Modificar Prioridad</li>
   </ol>
 </section>
 ...
 <section class="content">
    <div class="box box-info">
         <!-- form start -->
        <form action="{$rutaCSS}../controlador/modificarPrioridadAction.php" class="form-horizontal">
            <div class="box-body">
                <div class="box">
