...
<div class="content-wrapper">
 ...
 <section class="content-header">
   ...
   <ol class="breadcrumb">
     ...
     <li class="active">Administración > Departamentos > Modificar Departamento</li>
   </ol>
 </section>
 ...
 <section class="content">
    <div class="box box-info">
         <!-- form start -->
        <form action="{$rutaCSS}../controlador/modificarDepartamentoAction.php" class="form-horizontal">
            <div class="box-body">
                <div class="box">
