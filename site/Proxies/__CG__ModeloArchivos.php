 ...
 */
class Archivos extends \Modelo\Archivos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Modelo\\Archivos' . "\0" . 'archivoId', '' . "\0" . 'Modelo\\Archivos' . "\0" . 'nombre', '' . "\0" . 'Modelo\\Archivos' . "\0" . 'hash', '' . "\0" . 'Modelo\\Archivos' . "\0" . 'fechaCreacion', '' . "\0" . 'Modelo\\Archivos' . "\0" . 'directorio', '' . "\0" . 'Modelo\\Archivos' . "\0" . 'mensaje', '' . "\0" . 'Modelo\\Archivos' . "\0" . 'ticket'];
        }
     ...
     * {@inheritDoc}
     */
    public function addMensaje(\Modelo\Mensajes $mensaje)
    {
     ...
     * {@inheritDoc}
     */
    public function removeMensaje(\Modelo\Mensajes $mensaje)
    {
     ...
     * {@inheritDoc}
     */
    public function addTicket(\Modelo\Tickets $ticket)
    {
     ...
     * {@inheritDoc}
     */
    public function removeTicket(\Modelo\Tickets $ticket)
    {
