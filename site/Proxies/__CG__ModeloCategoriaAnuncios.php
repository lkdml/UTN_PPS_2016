 ...
 */
class CategoriaAnuncios extends \Modelo\CategoriaAnuncios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Modelo\\CategoriaAnuncios' . "\0" . 'categoriaId', '' . "\0" . 'Modelo\\CategoriaAnuncios' . "\0" . 'nombre', '' . "\0" . 'Modelo\\CategoriaAnuncios' . "\0" . 'icono'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoriaAnuncios $proxy) {
    ...
    public function getCategoriaId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCategoriaId();
        }
