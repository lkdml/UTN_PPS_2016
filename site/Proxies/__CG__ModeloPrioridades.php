 ...
 */
class Prioridades extends \Modelo\Prioridades implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Modelo\\Prioridades' . "\0" . 'prioridadId', '' . "\0" . 'Modelo\\Prioridades' . "\0" . 'nombre', '' . "\0" . 'Modelo\\Prioridades' . "\0" . 'descripcion', '' . "\0" . 'Modelo\\Prioridades' . "\0" . 'color', '' . "\0" . 'Modelo\\Prioridades' . "\0" . 'orden'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Prioridades $proxy) {
    ...
    public function getPrioridadId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPrioridadId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPrioridadId', []);

        return parent::getPrioridadId();
    }
