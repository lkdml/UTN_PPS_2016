 ...
 */
class Rol extends \Modelo\Rol implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Modelo\\Rol' . "\0" . 'nombre', '' . "\0" . 'Modelo\\Rol' . "\0" . 'descripcion', '' . "\0" . 'Modelo\\Rol' . "\0" . 'perfil'];
        }
     ...
     * {@inheritDoc}
     */
    public function addPerfil(\Modelo\Perfil $perfil)
    {
     ...
     * {@inheritDoc}
     */
    public function removePerfil(\Modelo\Perfil $perfil)
    {
